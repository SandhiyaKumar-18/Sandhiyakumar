...
<div className="pr-1-mobile">
        <h1 className="pr-title-mobile">Airbnb clone</h1>
        <div className="pr-flex-mobile">
            <div className="Discription-mobile">
                <h1 className="dis-mobile"> Discription</h1>
                <p className="dis-para-mobile">Airbnb clone,it just a clone of an real airbnb website.Need to write simple explanation about the projects.</p>
